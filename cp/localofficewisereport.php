            ...
            <div class="galerie preeti">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td colspan="14" style="text-align: center;">
                            आ.व. <?php echo $_SESSION["fiscal_year"]; ?> (स्थानीय)
                        </td>
                    </tr>
                ...
                <form name="del" action="" method="post">
                    <table align="center" border="1" class="table">
                        ...
                        $result = $dbc->generateIndividualLocalReport($_GET['oid']);
                        if ($result) {
                            ...
                            while ($row = mysqli_fetch_array($sql)) {
                                ...
                                <tr bgcolor="<?php echo $row['color'] ?>" style="font-weight:bold;">
                                    <td align="left" width="5%"><span
                                                class="siddhi"><?php echo $row['activity_number'] ?></span></td>
