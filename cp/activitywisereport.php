                ...
                <div class="galerie preeti">
                    ...
                    <form name="del" action="" method="post">
                        <table width="100%" align="center" border="1" class="table">
                            ...
                            <?php $sql = $dbc->selectActivityWiseReport($activity_code);
                            $i = 1;
                            while ($row = mysqli_fetch_array($sql)) {
                                ...
                                <tr>
                                    <?php
                                    $percentageYearlyQty = $row['yearly_alloc_qty'] == 0 || $row['yearly_progress_qty'] ? 0 : $row['yearly_progress_qty'] / $row['yearly_alloc_qty'] * 100;
                                    $percentageYearlyExpenditure = $row['yearly_alloc_budget'] == 0 || $row['yearly_progress_expenditure'] ? 0 : $row['yearly_progress_expenditure'] / $row['yearly_alloc_budget'] * 100;
                                    $percentageQThreeQty = $row['q3_alloc_qty'] == 0 || $row['q3_progress_qty'] ? 0 : $row['q3_progress_qty'] / $row['q3_alloc_qty'] * 100;
                                    $percentageQThreeExpenditure = $row['q3_alloc_budget'] == 0 || $row['q3_progress_expenditure'] ? 0 : $row['q3_progress_expenditure'] / $row['q3_alloc_budget'] * 100;
                                    ?>
