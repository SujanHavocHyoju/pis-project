		...
		<div id="content-box-in">
			...
			<div id="content-box-in-left">
				<div id="content-box-in-left-in">
					<h3 class="line"><span class="preeti" style="font-size:23px;">स्थानीय तह  </span></h3>
...
<div class="galerie">
    <table width="100%" align="center" border="1" class="table">
        ...
        <?php $sql =$dbc->selectLocalOffice();
        while($row = mysqli_fetch_array($sql)){
            $activityResult = mysqli_fetch_array($dbc->countLocalActivities($row['id']));
            $undoneResult = mysqli_fetch_array($dbc->countLocalActiviesWhichIsUnDone($row['id']));
            ?>
            <tr>
                ...
                <td align="center"  width="12%"  bgcolor="#999999"><span class="preeti">
                                            ...
                                            <a href="dashboard.php?action=localofficewisereport&oid=<?php echo $row['id'];?>&type=local&o_name=<?php echo $row['name_np']?>" class="edit">प्रगति विवरण प्रतिवेदन</a>
