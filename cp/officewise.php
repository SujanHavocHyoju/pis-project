...
<?php if (isset($_POST['btnfind'])) {
    ...
    echo "<script>location.href='http://localhost/pis-project/cp/dashboard.php?action=officewisereport&aid=" . $aid . "&acode=" . $acode['code']. "';</script>";
} ?>
    ...
    <div id="content-box-in">
        ...
        <div id="content-box-in-left">
            <div id="content-box-in-left-in">
                <h3 class="line"><span class="preeti" style="font-size:23px">क्रियाकलाप छान्नुहोस (कार्यालयगत
                            प्रतिवेदन)</span></h3>
                ...
                <div class="galerie">
                    ...
                    <form name="officewise" method="POST">
