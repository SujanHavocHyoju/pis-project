            ...
            <div id="content-box-in-left">
                <div id="content-box-in-left-in">
                    ...
                    <div class="galerie preeti">
                        स्थानीय निकाय : <?php echo $_GET['name'] ?><br>आ.व. : <?php echo $_SESSION['fiscal_year']; ?>
                        <br>
                        <p align="right"><a href="dashboard.php?action=entryLocal">अघिल्लो पेजमा जाने</a> || <a href="#"
...
//                                var_dump($row);
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="siddhi"><?php echo $row['local_activity3_desc_np'] ?></span>
                                        </td>
                                        <td><span class="siddhi"><?php echo $row['desc_np'] ?></span></td>
                                        <td><span class="siddhi"></span></td>
                                        <td align="right"><span
                                                    class="preeti"><?php echo $row['yearly_alloc_qty'] ?></span></td>
                                        <td align="right"><span
                                        ...
                                        <td align="center" style="width: 80px"><p><input type="button"
                                                                                         onclick="window.location.href='dashboard.php?action=entryLocalThree&oid=<?php echo $_GET['oid'] ?>&tlid=<?php echo $row['id'] ?>'"
                                                                                         class="delete"
                                                                                         value=" प्रगति थप गर्ने "></p>
                                        </td>
