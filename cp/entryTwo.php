                                ...
                                while ($row = mysqli_fetch_array($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><p><input type="button"
                                                                     onclick="window.location.href='dashboard.php?action=entryThree&oid=<?php echo $_GET['oid'] ?>&tlid=<?php echo $row['id'] ?>&name=<?php echo $row['name_np']; ?>'"
                                                                     class="delete" value=' प्रगति थप गर्ने '></p></td>
                                    </tr>
                                <?php } ?>
                                <tr bgcolor='#FFFF00'>
                                    <td><span class="siddhi"></span></td>
