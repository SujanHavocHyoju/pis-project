                ...
                <form name="del" action="" method="post">
                    <table width="100%" align="center" border="1" class="table">
                        ...
                        <tr bgcolor='#FFFF00'>
                            ...
                            <td><span class="siddhi"></span></td>
                            <td align="right" style="width:0.4em;"><span class="preeti" ><?php echo $resultOfSum['yaq']; ?></span></td>
                            ...
                            <td align="right"  style="width:0.6em;"><span class="preeti"><?php echo $resultOfSum['ypq'] ?></span></td>
                            <td align="right" ><span class="preeti"><?php echo $resultOfSum['ype'] ?></span></td>
                            <td align="right" ><span class="preeti"><?php echo $resultOfSum['ype'] ?></span></td>
                            <td align="right"><span class="preeti" style="width:0.6em;"><?php echo $resultOfSum['qaq'] ?></span></td>
                            <td align="right"><span class="preeti"><?php echo $resultOfSum['qab'] ?></span></td>
                            <td align="right"  style="width:0.6em;"><span class="preeti"><?php echo $resultOfSum['qpq'] ?></span></td>
